...
public class AStarState
{
    ...
    private Map<Location, Waypoint> open
            = new java.util.HashMap<Location, Waypoint>();
    // набор закрытых вершин
    private Map<Location, Waypoint> close
            = new java.util.HashMap<Location, Waypoint>();
    ...
    public Waypoint getMinOpenWaypoint()
    {
        if (numOpenWaypoints() == 0)
            return null;
        ArrayList<Waypoint> waypoints = new ArrayList<Waypoint>(open.values());
    ...
    {
        // если в наборе открытых вершин нет вершины для данного местоположения, добавляю новую вершину
        ...
        // проверка на стоимость пути для новой вершины
        {
